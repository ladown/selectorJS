...
window.addEventListener('DOMContentLoaded', function () {
  var getTemplate = function getTemplate() {
    ...
    var text = placeholder !== null && placeholder !== void 0 ? placeholder : 'Выберите что-то!';
  ...
  var Select = /*#__PURE__*/function () {
    ...
    _createClass(Select, [{
      ...
      value: function clickHandler(e) {
        if (e.target.dataset.type === 'input' || e.target.dataset.type === 'arrow' || e.target.dataset.type === 'value') {
          this.toggle();
      ...
      value: function select(id) {
        ...
        this.$el.querySelector("[data-id=\"".concat(id, "\"]")).classList.add('select__item-selected');
  ...
  var select = new Select('#select', {
    ...
    onSelect: function onSelect(item) {
      console.log("Selected item: ".concat(item.id, ".").concat(item.value));
    }
  });
  window.s = select;
});
